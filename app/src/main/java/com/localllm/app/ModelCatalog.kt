...
/**
 * True when the model isn't backed by a `.litertlm` file on disk — currently
 * just AICore (Gemini Nano) routed through the ML Kit Prompt API. UI uses
 * this to hide Download/Delete buttons and render a "system-provided" chip.
 */
val ModelInfo.isVirtual: Boolean get() = backend == Backend.AICORE
